export const CLIENT_CONFIG = {
  FRONTEND_URL: import.meta.env.VITE_FRONTEND_URL || 'https://kct-menswear-frontend.vercel.app',
  BACKEND_URL: import.meta.env.VITE_API_BASE_URL || 'https://front-of-the-backend-production.up.railway.app',
