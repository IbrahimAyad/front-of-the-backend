...
export const CLIENT_CONFIG = {
  FRONTEND_URL: import.meta.env.VITE_FRONTEND_URL || 
    (isProduction ? 'https://kct-menswear-frontend.vercel.app' : 'http://localhost:3001'),
  
  BACKEND_URL: import.meta.env.VITE_API_BASE_URL || 
    (isProduction ? 'https://front-of-the-backend-production.up.railway.app' : 'http://localhost:8000'),
  
  WS_BASE_URL: import.meta.env.VITE_WS_BASE_URL || 
    (isProduction ? 'wss://front-of-the-backend-production.up.railway.app/ws' : 'ws://localhost:8000/ws'),
